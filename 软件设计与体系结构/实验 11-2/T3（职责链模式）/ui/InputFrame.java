...
public class InputFrame extends JFrame{
    ...
    class FileListener implements ActionListener{
        ...
        class ConfirmListener implements ActionListener{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String outcome=new OutputApprover().processRequest(sentences,"input f",filename);
    ...
    class CListener implements ActionListener{
        ...
        class ConfirmListener implements ActionListener{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String outcome=new OutputApprover().processRequest(sentences, "input c", in);
    ...
    class DbListener implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            String outcome=new OutputApprover().processRequest(sentences, "input d", "");
