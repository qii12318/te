...
public class OutputFrame extends JFrame{
    ...
    class FileListener implements ActionListener{
        ...
        class ConfirmListener implements ActionListener{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String outcome=new OutputApprover().processRequest(sentences,"output f", filename);
    ...
    class CListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OutputFrame.this.dispose();
            String outcome=new OutputApprover().processRequest(sentences, "output c", "");
            pa.setText(outcome);
    ...
    class DbListener implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            String outcome=new OutputApprover().processRequest(sentences, "output d", "");
