...
public class OutputFrame extends JFrame{
    ...
    class FileListener implements ActionListener{
        ...
        class ConfirmListener implements ActionListener{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String outcome=new Facade().outputByFile(sentences, filename);
    ...
    class CListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            OutputFrame.this.dispose();
            String outcome=new Facade().outputByRead(sentences);
            pa.setText(outcome);
    ...
    class DbListener implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            String outcome=new Facade().outputByDB(sentences);
